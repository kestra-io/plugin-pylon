    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.pylon.PylonTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class PylonTask extends Task implements RunnableTask<PylonTask.Output> {
    @Schema(
    ...
    @Override
    public PylonTask.Output run(RunContext runContext) throws Exception {
